...
manifest={'productionUrl':prod,'release':'v13-agialpha-token-market-boundary','builtAt':datetime.datetime.utcnow().isoformat()+'Z','files':[]}
...
(dist/'production-url.json').write_text(json.dumps({'url':prod,'status':'PASS','operatorParity':'PASS','sovereignMachineEconomy':'PASS','finalAssurance':'PASS','legalDataZeroShield':'PASS','agialphaTokenBoundary':'PASS'},indent=2))
