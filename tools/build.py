...
manifest={'productionUrl':prod,'release':'v22-claim-boundary-firewall','builtAt':datetime.datetime.now(datetime.UTC).isoformat().replace('+00:00','Z'),'files':[]}
