...
ok(/Public Trust Ultimate Failsafe Publisher v45/i.test(wf), 'workflow names v45 ultimate failsafe publisher');
ok(wf.includes('tools/failsafe-bootstrap-v45.mjs'), 'workflow includes v45 bootstrap helper');
