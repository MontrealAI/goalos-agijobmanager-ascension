...
const manifestPath = ['data/canonical-route-manifest-v48.json','data/canonical-route-manifest-v45.json','data/canonical-route-manifest-v43.json'].find((p)=>fs.existsSync(p));
...
console.log(`PASS · public-trust metadata v48 applied to ${count} site HTML files`);
