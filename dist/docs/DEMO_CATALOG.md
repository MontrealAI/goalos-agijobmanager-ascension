...
Start with [Experience Concierge](../site/experience-concierge.html). It guides new users to the right proof path. Use [Command Center](../site/command-center.html) when you want the full route catalog.

## Canonical demo and route catalog
...
| [`/archive-v36-ascension-chamber.html`](../site/archive-v36-ascension-chamber.html) | Archivists | Preserved historical chamber view for release continuity. | Archive page | Archived reference. |
| [`/archive-v37-pre-navigation-final.html`](../site/archive-v37-pre-navigation-final.html) | Archivists | Preserved pre-navigation-final state for provenance. | Archive page | Archived reference. |
...
- The purpose of the page in plain language.
- What proof object, docket, receipt, or boundary is being demonstrated.
- What the page does not prove.
- A clear next step for non-technical users.
- A public-safe boundary: no account, no form, no analytics, no cookies, no browser storage, no public wallet connection, no token approval, no transaction broadcast, and no production authority.
