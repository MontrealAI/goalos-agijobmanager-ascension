...
GoalOS AGIJobManager Ascension now treats the route catalog as a public proof surface. The route manifest is generated from the actual static site and exposes 63 public routes.
