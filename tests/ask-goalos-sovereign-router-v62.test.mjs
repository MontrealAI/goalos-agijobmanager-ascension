...
if(!String(routing.version||'').includes('v62') && !String(routing.version||'').includes('v64') && !String(routing.version||'').includes('v65') && !String(routing.version||'').includes('v66')) fail('routing data version not v62-compatible');
