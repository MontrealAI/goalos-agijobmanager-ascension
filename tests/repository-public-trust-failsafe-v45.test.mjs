...
ok(/Publisher v45/i.test(wf), 'workflow identifies v45 publisher');
ok(wf.includes('Bootstrap zero-missing-test public-trust tooling'), 'workflow bootstraps zero-missing-test tooling');
...
ok(fs.existsSync('tests/repository-public-trust-failsafe-v45.test.mjs'), 'v45 public trust failsafe test is present');
ok(fs.existsSync('tools/repository-public-trust-failsafe-v45-kernel.mjs'), 'v45 public trust failsafe kernel exists');
