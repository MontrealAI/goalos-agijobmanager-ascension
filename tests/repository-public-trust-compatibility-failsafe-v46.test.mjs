...
ok(/Publisher (?:v4[6789]|v5[0-9])/i.test(wf), 'workflow identifies v46/v47/v48/v49/v50-compatible publisher');
ok(wf.includes('failsafe-bootstrap-v50.mjs') || wf.includes('failsafe-bootstrap-v49.mjs') || wf.includes('failsafe-bootstrap-v48.mjs') || wf.includes('failsafe-bootstrap-v47.mjs') || wf.includes('failsafe-bootstrap-v46.mjs'), 'workflow uses v46/v47 bootstrap helper');
...
ok(/v42/i.test(v42) && /v45\|v46\|v47\|v48|v45\|v46\|v47\|v48|v45|v46|v47|v48/i.test(v42), 'v42 kernel accepts current v45/v46/v47 public-trust lineage and v42 compatibility');
ok(fs.existsSync('tools/public-trust-checker-v50.mjs') || fs.existsSync('tools/public-trust-checker-v49.mjs') || fs.existsSync('tools/public-trust-checker-v48.mjs') || fs.existsSync('tools/public-trust-checker-v47.mjs') || fs.existsSync('tools/public-trust-checker-v46.mjs'), 'v46/v47 public-trust checker exists');
ok(fs.existsSync('tools/loop-to-rsi-sovereign-governance-v50-kernel.mjs') || fs.existsSync('tools/loop-evidence-reactor-v49-kernel.mjs') || fs.existsSync('tools/repository-public-trust-day-scale-loop-v48-kernel.mjs') || fs.existsSync('tools/repository-public-trust-loop-operating-room-v47-kernel.mjs') || fs.existsSync('tools/repository-public-trust-compatibility-failsafe-v46-kernel.mjs'), 'v46/v47 compatibility failsafe kernel exists');
